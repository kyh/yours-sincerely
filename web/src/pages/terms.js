    ...
    <AboutContainer>
      <div className="about-content">
        ...
        <p>
          ...
          related to it, still belong to Kaiyu Hsu.
        </p>
        <p>
          Kaiyu Hsu is committed to ensuring that the app is as useful and
        ...
        <p>
          The Yours Sincerely app stores and processes personal data that you
          ...
          Yours Sincerely app won’t work properly or at all.
        </p>
        <p>
        ...
        <p>
          You should be aware that there are certain things that Kaiyu Hsu will
          ...
          Wi-Fi, or provided by your mobile network provider, but Kaiyu Hsu
        ...
        <p>
          Along the same lines, Kaiyu Hsu cannot always take responsibility for
          ...
          avail the Service, Kaiyu Hsu cannot accept responsibility.
        </p>
        <p>
          With respect to Kaiyu Hsu’s responsibility for your use of the app,
          ...
          that we can make it available to you. Kaiyu Hsu accepts no liability
        ...
        <p>
          ...
          using the app. Kaiyu Hsu does not promise that it will always update
