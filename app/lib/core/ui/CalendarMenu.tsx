...
export const CalendarMenu = ({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 w-48 px-1 py-1 mt-2 origin-top-right bg-white divide-y rounded-md shadow-lg divide-slate-100 ring-1 ring-black ring-opacity-5 focus:outline-none">
          <Menu.Item>
            <a
              href={links.google}
              target="_blank"
