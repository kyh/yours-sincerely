      ...
      },
      {
        ...
        value: function position() {
          ...
          if (
            ...
            (function () {
              var offsetParent = _this5.cache(
                "target-offsetparent",
                function () {
                  return getOffsetParent(_this5.target);
                }
              );
              var offsetPosition = _this5.cache(
        ...
        value: function move(pos) {
          ...
          var transcribe = function transcribe(_same, _pos) {
            var hasOptimizations =
              typeof _this6.options.optimizations !== "undefined";
          ...
          for (var key in css) {
            ...
            if (
              elVal !== "" &&
              val !== "" &&
              ["top", "left", "bottom", "right"].indexOf(key) >= 0
            ) {
