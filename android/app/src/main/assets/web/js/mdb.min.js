        ...
        if (!t.jQuery) {
          ...
          for (
            var s = {},
              a = s.hasOwnProperty,
              o = s.toString,
              r = "Boolean Number String Function Array Date RegExp Object Error".split(
                " "
              ),
              l = 0;
            l < r.length;
                                ...
                                n === s &&
                                  ...
                                  "stop" === v
                                    ? (o(n) &&
                                        o(n).tweensContainer &&
                                        a !== !1 &&
                                        f.each(o(n).tweensContainer, function (
                                          t,
                                          e
                                        ) {
      ...
      (i.Scale = i.Element.extend({
        ...
        calculateXLabelRotation: function () {
          ...
          var i,
            ...
            e = this.ctx.measureText(this.xLabels[this.xLabels.length - 1])
              .width;
          if (
