  ...
  return (
    <main className={classes.page}>
      ...
      <section className={classes.pageContainer}>
        ...
        <p>Welcome to Yours Sincerely!</p>
        <p>
        ...
        <p>
          ...
          conditions. Do not continue to use Yours Sincerely if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Yours Sincerely, you agreed
          to use cookies in agreement with the Yours Sincerely's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Yours Sincerely and/or its licensors own the
          intellectual property rights for all material on Yours Sincerely. All
          intellectual property rights are reserved. You may access this from
          Yours Sincerely for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from Yours Sincerely</li>
          <li>Sell, rent or sub-license material from Yours Sincerely</li>
          <li>Reproduce, duplicate or copy material from Yours Sincerely</li>
          <li>Redistribute content from Yours Sincerely</li>
        </ul>
        ...
        <p>
          ...
          views and opinions. To the extent permitted by applicable laws, Yours
          Sincerely shall not be liable for the Comments or for any liability,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Yours Sincerely; and (d) the
        ...
        <p>
          No use of Yours Sincerely's logo or other artwork will be allowed for
